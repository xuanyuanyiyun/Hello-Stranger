...
export default function Register() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // 注册逻辑
    console.log('注册', { name, email, phone, password, confirmPassword });
  };
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-full flex items-center justify-center mx-auto mb-4">
            <span className="text-white font-bold text-2xl">你好</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-800">创建账号</h1>
          <p className="text-gray-600 mt-2">加入我们，开始你的社交之旅</p>
        </div>

        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-6">
          <div className="mb-4">
            <label htmlFor="name" className="block text-sm font-medium text-gray-700 mb-1">用户名</label>
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white py-2 rounded-lg font-medium hover:opacity-90 transition-opacity"
          >
            注册
          </button>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              已有账号？ <a href="/login" className="text-purple-600 hover:text-purple-700 font-medium">立即登录</a>
            </p>
          </div>
        </form>

        <div className="mt-6 text-center">
          <p className="text-sm text-gray-500">其他注册方式</p>
