    ...
    <div className="pt-20 pb-20 flex items-center justify-center min-h-screen">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">登录后开始你的社交之旅</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm p-6">
          ...
          <div className="mb-6">
            ...
            <div className="flex justify-end mt-2">
              <a href="#" className="text-sm text-purple-600 hover:text-purple-700">忘记密码？</a>
            </div>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              还没有账号？ <a href="/register" className="text-purple-600 hover:text-purple-700 font-medium">立即注册</a>
            </p>
          </div>
        </form>
